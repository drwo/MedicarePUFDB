...
```{r}
write_tsv(claim, "./pufdbdocker/claim.tsv", col_names = FALSE)
write_tsv(genent, "./pufdbdocker/genent.tsv", col_names = FALSE)
write_tsv(hcpcs, "./pufdbdocker/hcpcs.tsv", col_names = FALSE)
```
